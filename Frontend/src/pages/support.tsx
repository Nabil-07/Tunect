...
export default function SupportPage() {
  ...
  return (
    <main className="bg-slate-50/60 py-6" data-testid="support-page">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                data-testid="support-tab-chatbot"
              >
                Chatbot
              </button>
              <button
                ...
                data-testid="support-tab-support-chat"
              >
                Support Chat
              </button>
              {role === 'STUDENT' && (
                <button
                  ...
                  data-testid="support-tab-refunds"
                >
                  Refunds & Transfers
                </button>
              )}
              ...
              <div className="rounded-2xl border bg-white shadow-sm p-4">
                ...
                <div className="space-y-2 mb-3">
                  <input
                    ...
                    data-testid="support-ticket-subject-input"
                  />
                  <textarea
