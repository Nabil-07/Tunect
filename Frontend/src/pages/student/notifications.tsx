...
export default function NotificationsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6" data-testid="student-notifications-page">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          {unreadCount > 0 && (
            <button
              ...
              data-testid="student-notifications-mark-all-read-btn"
            >
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            data-testid="student-notifications-filter-all-btn"
          >
            All
          </button>
          <button
            ...
            data-testid="student-notifications-filter-unread-btn"
          >
            Unread
          </button>
        </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    {n.bookingId && (
                      <Link
                        ...
                        data-testid="student-notifications-view-booking-link"
                      >
                        View Booking →
                      </Link>
                    )}
                  ...
                  {!n.isRead && (
                    <button
                      ...
                      title="Mark as read"
                      data-testid="student-notifications-mark-read-btn"
                    >
