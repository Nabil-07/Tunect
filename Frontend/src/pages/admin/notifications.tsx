...
export default function AdminNotificationsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6" data-testid="admin-notifications-page">
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
              filter === 'all' ? 'bg-blue-600 text-white' : 'bg-white text-slate-700 hover:bg-slate-100'
            }`}
          >
            All
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
              filter === 'unread' ? 'bg-blue-600 text-white' : 'bg-white text-slate-700 hover:bg-slate-100'
            }`}
          >
            Unread
          </button>
